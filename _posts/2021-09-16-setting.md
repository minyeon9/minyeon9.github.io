...
* * *
**1) 다운로드**
![Alt text](/images/setting_java_img01.png)   
우리반은 11버전을 사용하기로 했다. 표시 된 것으로 설치.   
   
      
** 2) 버전 확인***
![Alt text](/images/setting_java_img02.png)    
[Window] - [cmd 입력]   
...
![Alt text](/images/setting_java_img03.png)
...
![Alt text](/images/setting_java_img04.png)   
...
![Alt text](/images/setting_java_img05.png) 
   
**5. java HelloWorld**
*HelloWorld 텍스트가 잘 나오는지 확인
![Alt text](/images/setting_java_img06.png)
여기까지가 Java 코드를 작성하고   
...
**1) 다운로드**
![Alt text](/images/setting_java_img07.png)
최신버전으로 다운 받았다.   
   
![Alt text](/images/setting_java_img08.png)
...
**2) 인코딩 설정**
![Alt text](/images/setting_java_img09.png)   
